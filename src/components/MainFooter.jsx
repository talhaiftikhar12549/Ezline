...
export default function MainFooter() {
    return (
        <>
            <div className="h-[100vh] bg-[#212331]">


                <div className="flex px-40 py-32 w-[100%]">
                    ...
                    <div className="w-[33%] px-3">
                        ...
                        <div>
                            <div className="w-[100%] flex border-b-[1px] py-4">
                                <div className="w-[30%]">
                                    <img src={caenderLogo} alt="" className="w-20 h-20" />
                                </div>
                                <div className="w-[70%]">
                                    <p className="text-[#829aae] hover:text-[#02b8cd]">16th Anniversary</p>
